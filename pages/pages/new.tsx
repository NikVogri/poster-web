...
const NewPage = () => {
	...
	return (
		<Container>
			<h1 className={styles.heading__primary}>Create a new page</h1>
			<Formik
			...
			>
				<Form>
					<Field name="title">
						{({ field, form }) => (
							<div>
								<h2 className={styles.heading__section}>
									Title
								</h2>
								<input
					...
					<div>
						<div className={styles.selection__container}>
							...
							>
								...
								<p className={styles.description}>
									Your own accessible anywhere digital
									notebook
								</p>
							</SelectCard>
							<SelectCard
							...
							>
								...
								<p className={styles.description}>
									Never forget anything, create multiple to-do
									lists
								</p>
							</SelectCard>
						</div>
						...
						<div className={styles.selection__container}>
							...
							>
								...
								<p className={styles.description}>
									Accessable to anyone with a link.
								</p>
							</SelectCard>
							<SelectCard
								id="private"
							...
							>
								<p className={styles.title}>Private</p>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="64"
									height="64"
								...
								<p className={styles.description}>
									Only you and invited users can access this
									page.
								</p>
							</SelectCard>
						</div>
					...
					<LoadingButton isLoading={loading} className="form-button">
						Create Page
					</LoadingButton>
				</Form>
			</Formik>
