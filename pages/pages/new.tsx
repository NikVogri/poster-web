...
const NewPage = () => {
  const [selectedPageType, setSelectedPageType] = useState<"notebook" | "todo">(
    "notebook"
  );
  const [selectedPageAvailability, setSelectedPageAvailability] = useState<
    "public" | "private"
  >("public");
  ...
  const handleSelect = (
    ...
    if (type === "page") {
      setSelectedPageType(selection as "notebook" | "todo");
    } else if (type === "availability") {
      setSelectedPageAvailability(selection as "public" | "private");
    }
  };

  const handleCreatePage = async (e: FormikValues) => {
    const data = {
      isPrivate: selectedPageAvailability === "public" ? false : true,
        ...
        <Form>
          <Field name="title">
            {({ field, form }) => (
              ...
              >
                ...
                <Input type="title" required placeholder="title" {...field} />
          ...
          <Flex mx="auto" flexDir="column" alignItems="center">
            <Flex mb={5}>
              <SelectCard
                id="notebook"
                isActive={selectedPageType === "notebook"}
                type="page"
              ...
              <SelectCard
                id="todo"
                isActive={selectedPageType === "todo"}
                type="page"
                onSelect={handleSelect}
              >
                <Text fontSize="lg" fontWeight="500" mb={3}>
            ...
            <Flex mb={5}>
              <SelectCard
                id="public"
                isActive={selectedPageAvailability === "public"}
                type="availability"
                onSelect={handleSelect}
              >
                <Text fontSize="lg" fontWeight="500" mb={3}>
                ...
                >
                  ...
                  <g fill="#303030">
                    ...
                    <circle fill="#303030" cx="24" cy="8" r="7"></circle>{" "}
              ...
              <SelectCard
                id="private"
                isActive={selectedPageAvailability === "private"}
                type="availability"
                onSelect={handleSelect}
              >
                <Text fontSize="lg" fontWeight="500" mb={3}>
